...
| 接口 | 方法 | 地址 |
|---|---|---|
| 保存快捷搜索信息 | POST | `/api/cube/list/saveQuickSearchInfo` |
| 保存查询模板默认值 | GET | `/api/cube/search/setDefault` |
| 初始化列宽接口 | GET | `/api/cube/search/cleanCol` |
| 删除数据接口 | GET | `/api/cube/expand/deleteData` |
| 判断数据是否改变接口 | POST | `/api/cube/search/checkDataChange` |
| 卡片数据保存接口(常用) | POST | `/api/cube/new/card/doSubmit` |
| 权限校验接口 | GET | `/api/cube/new/card/checkCardRight` |
| 查询快捷搜索信息获取接口 | GET | `/api/cube/list/getQuickSearchInfo` |
| 获取主表字段信息 | GET | `/api/cube/new/card/mainFields` |
| 获取二维码信息 | GET | `/api/cube/new/card/getQRCode` |
| 获取卡片iframe设置 | GET | `/api/cube/new/card/getIframe` |
| 获取卡片布局基本信息 | GET | `/api/cube/new/card/layoutBase` |
| 获取卡片明细表数据 | GET | `/api/cube/new/card/getDetailFields` |
| 获取卡片条形码信息 | GET | `/api/cube/new/card/getBarCode` |
| 获取字段联动信息 | GET | `/api/cube/new/card/getInputEntry` |
| 获取属性联动信息 | GET | `/api/cube/new/card/getFieldAttrLinkPage` |
| 获取查询列表基本信息 | GET | `/api/cube/search/init` |
| 获取查询权限信息 | GET | `/api/cube/list/getRightInfo` |
| 获取查询相关信息 | GET | `/api/cube/search/getList` |
...
/api/cube/list/saveQuickSearchInfo
...
/api/cube/search/checkDataChange
...
/api/cube/new/card/checkCardRight
...
/api/cube/list/getQuickSearchInfo
...
/api/cube/new/card/getDetailFields
...
/api/cube/new/card/getInputEntry
...
/api/cube/new/card/getFieldAttrLinkPage
